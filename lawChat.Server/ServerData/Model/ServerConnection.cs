...
namespace lawChat.Server.ServerData.Model
{
    public class ServerConnection
    {
        ...
        private readonly List<ServerConnection> _connectedClients;

        private readonly Action<ServerConnection> _dispose;
        ...
        private async void HandlerReceivedMessage(object sender, PackageMessage message)
        {
            switch (message.Header.MessageType)
            {
                case MessageType.Command:
                    if (message.Header.CommandArguments != null)
                    {
                        switch (message.Header.CommandArguments[0])
                        {
                                                    ...
                                                    connectedClient.Connection?.SendMessageAsync(new PackageMessage()
                                                    {
                                                        Header = new Header()
                                                        {
                                                            ...
                                                            CommandArguments = new[]
                                                                { "new client connection", UserData.Id.ToString() }
                                                        }
                                                    });
                                                }
                                            }
                                                ...
                                                Connection?.SendMessageAsync(new PackageMessage()
                                                {
                                                    Header = new Header()
                                                    {
                                                        ...
                                                        CommandArguments = new[]
                                                        {
                                                            ...
                                                            connectedClient.UserData.Id.ToString()
                                                        }
                                                    }
                                                });
                                            }
                            ...
                            case "messages":
                                try
                                {
                                    if (_context.Messages.Any())
                                    {
                                        ...
                                        {
                                            if ((msg.SenderId == messageSender &&
                                                 msg.RecipientId == messageRecipient) ||
                            ...
                            case "signup":
                                try
                                {
                                    ...
                                    if (_context.Clients.FirstOrDefault(x => x.NickName == newClient.NickName) ==
                                        null &&
